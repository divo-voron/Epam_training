...
namespace TaxiStation.Factory
{
    ...
    class CreatorSedan: Creator
    {
        ...
        private int _cargo;
        public CreatorSedan(int id, int speed, int fuelConsumptionm, int price, int curbWeight, int numberOfPassenger, int cargo, CarsControlSystemType carsControlSystemType = CarsControlSystemType.Human)
